...
```{r}
# mod_dat <- readRDS('/Users/raven/Documents/honors/honors-work/data/ag-modeling-data.RDS')
...
# saveRDS(mod_dat, '/Users/raven/Documents/honors/honors-work/data/ag-modeling-data.RDS')
mod_dat <- readRDS('/Users/raven/Documents/honors/honors-work/data/ag-modeling-data.RDS')
...
# Fit model
skew_tma_fit <- stan(model_code = skew_tma_code, data = tma_dat, iter = 1000, verbose = FALSE)
